	...
	<div class="addLogo" ><img src="{$smarty.const.WWW}templates/images/pistol.gif" /></div>
		<div class="addingWelcomeText">Резултати от вашето търсене в раздел <b>ПИСТОЛЕТИ</b> ,   Категория:<b>Револвери</b> ,Състояние: <b>Употребявани</b> , Марка:<b>Колт</b> ,Калибър:<b>Калибър1-1</b> ,Местоположение:<b>Каспичан</b> ,Цена:<b>от 100 до 200 лева</b> ,Снимки:<b>Със снимки</b> ,Давност:<b>От Днес</b> ,Сортирани по:<b>Цена</b> . Ако това не са изискванията на вашето търсене можете да направите:<br />
<div style="text-align:center;font-size:15px;font-weight:bold;margin-top:10px;"><a href="#" >Ново търсене</a> или <a  href="#">Корекция на търсенето</a></div></div>
		<div style="clear:both;">&nbsp;</div>
		
		<div class="searchResultHeader">1-20 от общо 150 резултата</div>
	   ...
	   <div class="adRowTextField">
	   	<div class="adHeadLine">Пистолет Колт 9мм &nbsp; <span class="adPrice">150 лева</span></div>
	   <div class="adText">
	   Револвер,Колт,9мм,Употребяван<br />
