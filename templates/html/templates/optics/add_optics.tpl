...
<li><span class="redStar">*</span>Модел:<br /><select class="aField" id="marka" name="marka">
  ...
  <option>Модел 4</option>
   <option>Модел 5</option>
	...
	<!--Размера на оптиките се сътои от 2 части тази е първата + 10-те числа отдолу -->
  				<option>1-8x</option>
...
<!-- това е втората част от размера на оптиките - тези числа винаги се прибавят към размерите на оптиките и размера за  търсене се получава например: 1-8х20 -->
