	...
	<div class="addLogo" ><img src="images/rifles_big.gif" width="80" /></div>
		<div class="addingWelcomeText">Резултати от вашето търсене в раздел <b>ПУШКИ</b> ,   Категория:<b>нарезни</b> ,Състояние: <b>Употребявани</b> , Марка:<b>ИЖ</b> , Модел:<b>Модел 1</b> ,Калибър:<b>Калибър1-1</b> ,Местоположение:<b>Каспичан</b> ,Цена:<b>от 100 до 200 лева</b> ,Снимки:<b>Със снимки</b> ,Давност:<b>От Днес</b> ,Сортирани по:<b>Цена</b> . Ако това не са изискванията на вашето търсене можете да направите:<br />
<div style="text-align:center;font-size:15px;font-weight:bold;margin-top:10px;"><a style="color:#685300; text-decoration:underline;" href="#" >Ново търсене</a> &nbsp; или &nbsp; <a style="color:#685300; text-decoration:underline;"  href="#">Корекция на търсенето</a></div></div>
	   ...
	   <div class="adRowTextField">
	   	<div class="adHeadLine">ИЖ модел 1  &nbsp; <span class="adPrice">150 лева</span></div>
	   <div class="adText">
