<div class="mainMenuBand">Публикуване на обява в катеория <b>ПУШКИ</b></div>
	<div class="mainField">
		<div class="addLogo" ><img src="images/rifles_big.gif" width="80" /></div>
	...
	<li><span class="redStar">*</span>Категория:<br /><select class="aField" id="category" name="category">
				<option>Щуцер(комбинирани)</option>
 				 <option>Гладкоцевни</option>
                <option>Нарезни</option>
...
<li><span class="redStar">*</span>Модел:<br /><select class="aField" id="marka" name="marka">
  ...
  <option>Модел 4</option>
   <option>Модел 5</option>
    ...
    <li><span class="redStar">*</span>Калибър на гладката цев:<br /><select class="aField" id="calibre" name="calibre">
  ...
  <option>Калнбър4</option>
   <option>Калнбър5</option>
	 ...
	 <li><span class="redStar">*</span>Калибър на нарезната цев:<br /><select class="aField" id="calibre" name="calibre">
  <option>Калнбър1</option>
  <option>Калнбър2</option>
  <option>Калнбър3</option>
  <option>Калнбър4</option>
   <option>Калнбър5</option>
	...
	<li><div><div style="float:left;"><span class="redStar">*</span>Цена:<br /><input class="aField" type="text" size="10" id="price"  name="price" /></div>
	<div style="float:left;"><span class="redStar">*</span>Валута:<br /><select class="aField" id="valuta" name="valuta">
  <option>Лева</option>
  <option>EUR</option>
	</select></div></div>
	<div style="clear:both;">&nbsp;</div>
