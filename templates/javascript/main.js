...
//За пистолетите ================================================
//Взема марките пистолети за даден вид пистолет
function getRifleMarks(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'rifle/marks/?type_id=' + type_id,
		dataType: "json",
		success: function (data) {
			$('#mark_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
...
//Взема моделите пистолети за даден вид пистолет
function getRifleModels(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'rifle/models/?mark_id=' + mark_id,
		dataType: "json",
		success: function (data) {
			$('#model_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
...
//Взема калибрите за дадена марка пистолет
function getRifleCalibers(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'rifle/calibers/?model_id=' + model_id,
		dataType: "json",
		success: function (data) {
			$('#caliber_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
...
//За оптиките========================================
//Взема марките пистолети за даден вид пистолет
function getOpticMarks(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'optic/marks/?type_id=' + type_id,
		dataType: "json",
		success: function (data) {
			$('#mark_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
...
//Взема моделите пистолети за даден вид пистолет
function getOpticModels(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'optic/models/?mark_id=' + mark_id,
		dataType: "json",
		success: function (data) {
			$('#model_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
...
//Взема калибрите за дадена марка пистолет
function getOpticSizes(id, add_empty) {
	var tmp_id;
	if ((typeof(id) == 'undefined') || (id === false)) {
		id = false;
		tmp_id = '';
	...
	$.ajax({
		type: "GET",
		url: WWW + 'optic/sizes/?model_id=' + model_id,
		dataType: "json",
		success: function (data) {
			$('#size_id' + tmp_id).find('option').remove();
			if ((typeof(add_empty) != 'undefined') && (add_empty)) {
				$('#size_id' + tmp_id).prepend("<option value='' selected='selected'></option>");
			}
			for(i in data) {
				$('#size_id' + tmp_id)
					.append($('<option>', { value : data[i].id })
			...
			if (id) {
				if ((typeof(default_size_id[id]) !== 'undefined') && (default_size_id[id])) {
					$('#size_id' + tmp_id).val(default_size_id[id]);
					default_size_id[id] = false;
				}
			} else {
				if ((typeof(default_size_id) !== 'undefined') && (default_size_id)) {
					$('#size_id' + tmp_id).val(default_size_id);
					default_size_id = false;
				}
			}
		},
		error: function (jqXHR, textStatus, errorThrown) {
